...
double get_Sc(Cell &cell, DIRECTION direction, VectorXd &p_solution, VectorXd &S_solution, double time);

//double get_boundary_value_p(Cell &cell, DIRECTION direction);
double get_boundary_value_Pc(Cell &cell, DIRECTION direction, double time);
...
double boundary_function_Pc(vec &point, double time);
